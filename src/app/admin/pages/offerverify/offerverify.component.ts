...
@Component({
  selector: 'app-offerverify',
  templateUrl: './offerverify.component.html',
  styleUrls: ['./offerverify.component.scss']
})
export class OfferverifyComponent implements OnInit {
  ...
  acceptAll() {
    ...
    if (this.verificationData.length) {
      this.http.post(this.authService.API_BASE_URL + '/admin/update/offer/approve', sendData)
        .toPromise()
        .then(
          respons => {
            this.refreshData();
  ...
  rejectAll() {
    ...
    if (this.verificationData.length) {
      this.http.post(this.authService.API_BASE_URL + '/admin/update/offer/reject', sendData)
        .toPromise()
        .then(
          respons => {
            this.refreshData();
  ...
  refreshData() {
    ...
    this.http.get(this.authService.API_BASE_URL + '/admin/search/offer')
      .toPromise()
      .then(
        respons => {
          this.onHoverID = '';
